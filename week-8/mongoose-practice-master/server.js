...
// Book.find({$and:[{pages:{$gt:200}},{pages:{$lt:500}}]}).then((books)=>{
//   console.log(books);
// })
...
// Person.find({$and:[{height:{$gt:180}},{salary:{$gt:30000}}]}).then((people)=>{
//     console.log(people);
// })

//2. Find all the people who are tall (>180) OR rich (>30000)
// Person.find({$or:[{height:{$gt:180}},{salary:{$gt:30000}}]}).then((people)=>{
//   console.log(people);
// })

//3. Find all the people who have grey hair or eyes, and are skinny (<70)
// Person.find({$and:[{$or:[{hair:"grey"},{eyes:"grey"}]},{weight:{$lt:70}}]}).then((people)=>{
//   console.log(people);
// })

//4. Find people who have at least 1 kid with grey hair
// Person.find({"kids.hair":"grey"}).then((people)=>{
//   console.log(people);
// })

//5. Find all the people who have at least one overweight kid, and are overweight themselves (>100)
Person.find({$and:[{"kids.weight":{$gt:100}},{weight:{$gt:100}}]}).then((people)=>{
  for(p in people){
    var person = people[p];
